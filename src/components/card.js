...
function CardComponent({ title, description, image, restaurantDetails, toggleDetails, webUrl}) {
  ...
  return (
    <a className="relative block bg-white border shadow-sm rounded-md dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70 hover:bg-zinc-800 transition duration-300 card-link" href={webUrl} target="_blank" rel="noopener noreferrer" onClick={toggleCardDetails}>
