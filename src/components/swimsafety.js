...
const imageData = [
  {
    ...
    facts:
      "Be careful of potential hazards in the water such as large waves or sharks",
  },
  {
    ...
    facts:
      "This symbol indicates it is a swimming area and you should swim between the red and yellow flags only.",
  },
  {
  ...
  },
  {
    ...
    facts:
      "Surfcraft riding area boundary. Avoid swimming in surfcraft areas if at all possible.",
  },
  {
    ...
    facts:
      "Emergency evacuation. Evacuate the water immediately for a variety of reasons, including sharks and hurricanes.",
  },
  {
  ...
  },
  {
    ...
    title: "No Vessels",
    facts:
      "Vessels, such as boats, jet skis, or other watercraft, is not allowed in the area.",
  },
  {
...
function SwimSafety() {
  ...
  return (
    <div id="swim">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 border my-6">
        <Slider
          ref={sliderRef}
          dots={true}
          infinite={true}
        ...
        <div className="flag-counter">
          {" "}
          Flag {flagCounter} / {imageData.length}
        </div>
      </div>
      ...
      <p>
        Beaches can be dynamic and unpredictable environments, with changing
        tides, currents, and weather conditions. Knowing how to recognize
        potential hazards and understanding beach safety signage can
        significantly reduce the risk of accidents and ensure a positive beach
      ...
      <p>
        ...
        Start exploring below safety & regulatory signs and empower yourself
        with the knowledge you need to stay safe and have fun at the beach!
      </p>
    </div>
  );
}
